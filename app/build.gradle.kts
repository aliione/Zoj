...
android {
  ...
  defaultConfig {
    applicationId = "com.aistudio.couplesgame.app"
    minSdk = 24
    targetSdk = 35
    versionCode = 1
    versionName = "1.0"
...
abstract class CopyApkTask : DefaultTask() {
  ...
  fun copy() {
    sourceApk.get().asFile.copyTo(targetApk.get().asFile, overwrite = true)
  }
}
...
tasks.register<CopyApkTask>("copyDebugApk") {
  ...
  targetApk.set(rootProject.layout.projectDirectory.file("app-debug.apk"))
}
